...
- Zavion Thomas (WR CHI) — KR+PR; offensive depth SWR 3; proj return yds 22.7/g; MEDIUM confidence
...
- Ray Davis — +5.55 return pts/g (KR + OFF, HIGH) — OWNED
- Will Shipley — +5.55 return pts/g (KR + OFF, HIGH) — FA
- Trevor Etienne — +5.27 return pts/g (KR+PR, HIGH) — FA
